...
import time
import cv2
from gestos_robot.msg import GestoAction, GestoResult, GestoFeedback
...
from src.detectors.gestures_hand import clasificar_gesto_mano, es_rock_roi, gesto_tirar_dado_roi
from src.detectors.gestures_face import es_guiño_roi, es_parpadeo_largo_roi
