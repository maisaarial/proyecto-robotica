...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/laboratorio/ros_workspace/install/lib/python3/dist-packages:/home/laboratorio/ros_workspace/build/detector_tablero/lib/python3/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/laboratorio/ros_workspace/build/detector_tablero" \
    "/usr/bin/python3" \
    "/home/laboratorio/ros_workspace/src/detector_tablero/setup.py" \
     \
    build --build-base "/home/laboratorio/ros_workspace/build/detector_tablero" \
    install \
    --root="${DESTDIR-/}" \
